...
class ContaCorrente(Conta):
    ...
    def depositar(self, deposito_valor: float):
            ...
            if deposito_valor:
                ...
                return f"Saque de {deposito_valor} realizado com sucesso. Saldo atual: {self._saldo_corrente}"
            else:
    ...
    def __str__(self):
        return f"Saldo atual da conta poupança: R$ {self._saldo_corrente:.2f}"
